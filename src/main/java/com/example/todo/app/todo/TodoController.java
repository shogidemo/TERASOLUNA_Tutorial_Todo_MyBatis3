...
public class TodoController {
	...
	@PostMapping("create")
	public String create(@Validated({ Default.class, TodoCreate.class }) 
						 TodoForm todoForm, 
		...
		//PRG(Post-Redirect-Get)パターンで、list画面にリダイレクトし、クライアント側からGetメソッドでlistフォームを取得することで、POSTメソッドの再実行を防ぐことができる。
